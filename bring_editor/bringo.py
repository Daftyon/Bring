...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="bringi.ico">
...
@app.route('/bringi.ico')
def favicon():
    """Serve the favicon file"""
    try:
        return send_from_directory('.', 'bringi.ico')
    except FileNotFoundError:
        # Return a 404 if the favicon file doesn't exist
        return '', 404
...
if __name__ == '__main__':
    ...
    print("   - Custom favicon (bringi.ico)")
